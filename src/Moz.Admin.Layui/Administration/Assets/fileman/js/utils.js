...
RoxyUtils.GetFileIcon = function(path){
  ret = '/Administration/Assets/fileman/images/filetypes/unknown.png';//'images/filetypes/file_extension_' + RoxyUtils.GetFileExt(path).toLowerCase() + '.png';
  if(fileTypeIcons[RoxyUtils.GetFileExt(path).toLowerCase()]){
    ret = '/Administration/Assets/fileman/images/filetypes/' + fileTypeIcons[RoxyUtils.GetFileExt(path).toLowerCase()];
  }
...
RoxyUtils.LoadLang = function(){
    var langUrl = '/Administration/Assets/fileman/lang/zh.json';
  $.ajax({
      url: langUrl,
      dataType: 'json',
      async:false,
