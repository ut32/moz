...
namespace Moz.Biz.Dtos.Articles.ArticleModels
{
    ...
    /// tab_article_model
    /// </summary>
    [Validator(typeof(UpdateArticleModelRequestValidator))]
    ...
    public class UpdateArticleModelResponse
    {
    
    }
    
    
    public class UpdateArticleModelRequestValidator : MozValidator<UpdateArticleModelRequest>
    {
        public UpdateArticleModelRequestValidator(ILocalizationService localizationService)
        {
