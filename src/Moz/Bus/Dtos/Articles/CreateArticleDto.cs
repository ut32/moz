...
namespace Moz.Biz.Dtos.Articles
{
    ...
    public class CreateArticleRequestValidator : MozValidator<CreateArticleRequest>
    {
        public CreateArticleRequestValidator(ILocalizationService localizationService)
        {
            RuleFor(x => x.ArticleTypeId).GreaterThan(0).WithMessage("发生错误");
        }
    }
