...
namespace Moz.Biz.Dtos.Articles
{
    ...
    public class PagedQueryArticleRequest
    {
        #region 属性
    ...
    public class PagedQueryArticleResponse: PagedResult<QueryArticleItem>
    {
    ...
    public class PagedQueryArticleRequestValidator : MozValidator<PagedQueryArticleRequest>
    {
