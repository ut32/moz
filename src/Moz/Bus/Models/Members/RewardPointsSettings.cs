...
namespace Moz.Bus.Models.Members
{
    public class RewardPointsSettings : ISettings
    {
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether all reward points are accumulated in one balance for all stores and they
        ///     can be used in any store. Otherwise, each store has its own rewards points and they can only be used in that store.
        /// </summary>
