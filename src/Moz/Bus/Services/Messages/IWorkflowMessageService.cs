...
namespace Moz.Service.Messages
{
    public interface IWorkflowMessageService
    {
        ...
        int SendCustomerRegisteredNotificationMessage(Member customer, int languageId);
        ...
        /// <param name="customer">Customer.</param>
        /// <param name="languageId">Language identifier.</param>
        int SendCustomerWelcomeMessage(Member customer, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendCustomerEmailValidationMessage(Member customer, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendCustomerEmailRevalidationMessage(Member customer, int languageId);
        ...
        /// <param name="languageId">Message language identifier</param>
        /// <returns>Queued email identifier</returns>
        int SendCustomerPasswordRecoveryMessage(Member customer, int languageId);
