...
namespace Moz.Settings
{
    ...
    public class CommonSettings : ISettings
    {
        ...
        /// <summary>
        /// </summary>
        public string AliyunOSSBucket { get; set; }

        /// <summary>
        /// </summary>
        public string AliyunOSSEndpoint { get; set; }

        /// <summary>
        /// </summary>
        public string AliyunOSSAccessKeyId { get; set; }

        /// <summary>
        /// </summary>
        public string AliyunOSSAccessKeySecret { get; set; }


        public string AliyunOSSServer { get; set; }
        ...
        /// <summary>
        ///     Gets or sets a value indicating whether to use stored procedure (if supported) for loading categories (it's much
        ///     faster in admin area with a large number of categories than the LINQ implementation)
        /// </summary>
